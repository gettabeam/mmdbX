...
public class OracleLogin extends Login {
  ...
  JTextField jTxt_sid = new JTextField();
  ...
  public OracleLogin(LoginPrompt parent,Properties loginparms) {
  ...
  //  this.setBorder(BorderFactory.createEtchedBorder());
    ...
    jTxt_port.setText("1521");
    jLabel3.setBounds(new Rectangle(28, 81, 59, 20));
    jLabel3.setHorizontalAlignment(SwingConstants.TRAILING);
    jLabel3.setText("SID");
    jTxt_sid.setBounds(new Rectangle(92, 78, 127, 26));
    jTxt_sid.setText("orastart");
    ...
    jLabel6.setText("Oracle Connect");
...
//    loginparms.put("PRESS","CANCEL");
    ...
    loginparms.put("sid",jTxt_sid.getText());
    loginparms.put("LOGIN","ORACLE");
